...
public class AlumnoController extends CommonController<Alumno, AlumnoService> {
	...
	public ResponseEntity<?> obtenerAlumnosXCurso(@RequestParam List<Long> ids){
	...
	public ResponseEntity<?> saveWithImg(@Valid Alumno alumno, BindingResult result, @RequestParam MultipartFile archivo) throws IOException {
		if(!archivo.isEmpty()) {
